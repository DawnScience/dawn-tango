...
public class PauseClass extends Command implements TangoConst
{
	//===============================================================
	/**
	 *	Constructor for Command class PauseClass
	 *
	 ...
	 */
	//===============================================================
	public PauseClass(String name,int in,int out)
	{
		super(name, in, out);
	}
	 ...
	 */
	//===============================================================
	public PauseClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public PauseClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	{
		Util.out2.println("PauseClass.execute(): arrived");
		((WorkflowExecutor)(device)).pause();
		return insert();
	}
