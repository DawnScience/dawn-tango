...
public class SetReviewDataClass extends Command implements TangoConst
{
	//===============================================================
	/**
	 *	Constructor for Command class SetReviewDataClass
	 *
	 ...
	 */
	//===============================================================
	public SetReviewDataClass(String name,int in,int out)
	{
		super(name, in, out);
	}
	 ...
	 */
	//===============================================================
	public SetReviewDataClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public SetReviewDataClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	{
		Util.out2.println("SetReviewDataClass.execute(): arrived");
		String argin = extract_DevString(in_any);
		((WorkflowExecutor)(device)).set_review_data(argin);
		return insert();
	}
