...
public class TestRetrieveStartValues
{
	...
	private void testEDNAActor() throws DevFailed {
		String[] arg0 = {"modelpath","common/tests/test_retrieveStartValues.moml", "x1", "10", "x2", "20"};
		DeviceData argin = new DeviceData();
		argin.insert(arg0);
    	logger.debug("Starting test_retrieveStartValues.moml workflow");
	...
	{
		final TestRetrieveStartValues testRunWorkflow = new TestRetrieveStartValues();
